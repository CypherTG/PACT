...
exports.ESCALATION_WINDOW_MONTHS = exports.ESCALATION_THRESHOLD = exports.RISK_LEVELS = exports.APPEAL_DECISIONS = exports.ESCALATION_TRIGGERS = exports.DISCIPLINARY_STATUS = exports.ACTION_TYPES = exports.STAFF_STATUS = exports.EMPLOYEE_TYPES = exports.COMPANIES = exports.CATEGORIES = exports.TIERS = exports.CASE_STATUS = exports.COLUMNS = exports.LIST_NAMES = exports.SHAREPOINT_SITE_ID = exports.SHAREPOINT_SITE_PATH = exports.SHAREPOINT_SITE_URL = void 0;
// ─── SharePoint Site ────────────────────────────────────────────────────────
exports.SHAREPOINT_SITE_URL = 'netorgft13110820.sharepoint.com';
exports.SHAREPOINT_SITE_PATH = '/sites/KONSTRUCTUM';
exports.SHAREPOINT_SITE_ID = ''; // Will be resolved at runtime via Graph
...
// ─── Enums ──────────────────────────────────────────────────────────────────
exports.CASE_STATUS = ['Unpaid', 'Paid', 'Overdue', 'Waived'];
exports.TIERS = ['Tier 1', 'Tier 2', 'Tier 3'];
exports.CATEGORIES = ['Conduct', 'Project Integrity', 'Strategic', 'EHSQ'];
exports.COMPANIES = ['KCC', 'KESL', 'Interkonstruct'];
exports.EMPLOYEE_TYPES = ['Employee', 'Consultant', 'Contractor'];
exports.STAFF_STATUS = ['Active', 'Inactive'];
exports.ACTION_TYPES = ['Warning', 'Fine', 'Suspension', 'Termination'];
exports.DISCIPLINARY_STATUS = ['Pending', 'Enforced', 'Appealed', 'Waived'];
exports.ESCALATION_TRIGGERS = ['System', 'Manual'];
exports.APPEAL_DECISIONS = ['Upheld', 'Reduced', 'Waived', 'Rejected'];
exports.RISK_LEVELS = ['Low', 'Medium', 'High', 'Critical'];
// ─── Escalation Rules ───────────────────────────────────────────────────────
exports.ESCALATION_THRESHOLD = 2; // Number of Tier 1 offences in history to trigger escalation on the NEXT one (e.g. 2 existing + 1 current = 3 total)
exports.ESCALATION_WINDOW_MONTHS = 6; // Rolling window in months
